...
import flag from '../../css/images/icones/16.png'

class Footerprp extends Component {
    render() {
        return (
            <div>
			...
			<div className="footer-links-wrapper row"> 
				<div className="links-wrapper-1 col-sm-12 col-md">
					<h3>Shop and Learn</h3>
                                <ul>
                                    <Footer linkName="mac" linkUrl="mac" />
                                    <Footer linkName="ipad" linkUrl="ipad" />
                                    <Footer linkName="iPhone" linkUrl="iPhone" />
                                    <Footer linkName="Watch" linkUrl="Watch" />
                                    <Footer linkName="TV" linkUrl="TV" />
                                    <Footer linkName="Music" linkUrl="Music" />
                                    <Footer linkName="AirPods" linkUrl="AirPods" />
                                    <Footer linkName="HomePod" linkUrl="HomePod" />
                                    <Footer linkName="iPod touch" linkUrl="iPod touch" />
                                    <Footer linkName="Accessories" linkUrl="Accessories" />
                                    <Footer linkName ="Gift Cards" linkUrl ="Gift Cards"/>
					</ul>
				</div> 
				<div className="links-wrapper-2 col-sm-12 col-md">
					<h3>Services</h3>
								<ul>
								<Footer linkName="Apple Music" linkUrl="Apple Music" />
                                    <Footer linkName="Apple News+" linkUrl="Apple News+" />
                                    <Footer linkName="Apple TV+" linkUrl="Apple TV+" />
                                    <Footer linkName="Apple Arcade" linkUrl="Apple Arcade" />
                                    <Footer linkName="Apple Card" linkUrl="Apple Card" />
                                    <Footer linkName="iCloud" linkUrl="iCloud" />
					</ul>
					<h3>Account</h3>
								<ul>
